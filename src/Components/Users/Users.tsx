  ...
  return (
    <div className='mx-4 md:mx-10 lg:mx-14 xl:mx-16 mb-10'>
     ...
     <div className='flex gap-4 '>
      <button className='py-2 px-5 rounded-lg font-semibold border text-lg text-black' type="button">import</button>
      <button className='bg-[#7F56D9] text-white py-2 px-5 rounded-lg font-semibold ' type="button">Add User</button>
     </div>
     </div>
...

      {
        ...
        <div className=' flex py-2 pl-3'>
         ...
         <input className='w-5 h-5' type="checkbox" value={""} name="time" />
        ...
        <div className='py-2 pl-3 '>
         ...
         <p className='text-[#667085] text-lg' > Super lightweight design app </p>
        </div>
